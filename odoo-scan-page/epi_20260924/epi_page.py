  ...
  <t t-call="website.layout">
    ...
    <div class="ep-wrap">
      ...
      <t t-else="">
        ...
        <t t-set="mvs" t-value="request.env['stock.move'].sudo().search([('state','=','done'),'|',('location_dest_id','=',loc_conso),('location_id','=',loc_conso)], order='date desc, id desc', limit=60)"/>
        ...
        <t t-set="mvs_an" t-value="request.env['stock.move'].sudo().search([('state','=','done'),('x_employee_id','!=',False),('date','&gt;=',annee + '-01-01'),('date','&lt;=',annee + '-12-31'),'|',('location_dest_id','=',loc_conso),('location_id','=',loc_conso)])"/>
        ...
        <div class="ep-grid">
          <div>
            ...
            <div class="ep-card">
              ...
              <div class="ep-help" style="margin-top:8px;">Nouvel EPI à suivre ? Dans Odoo, créer l'article dans la catégorie <b>EPI</b> avec « Suivre le stock » coché (tailles en variantes) : il apparaît ici aussitôt.</div>
            </div>
          </div>
          <div>
            <div class="ep-card">
