...
TRAVAUX_TABS = [
    ...
    ("poste", "Poste de relevage", [
        ("pomp_poste",      "Pompage nettoyage poste de relevage", "U"),
        ("pomp_puisard",    "Pompage nettoyage puisard",           "U"),
        ("pomp_regard",     "Pompage nettoyage regard de visite",  "U"),
        ("prest_pr_step",   "Prestations PR + STEP",               "U"),
        ("travaux_pompage", "Travaux de pompage",                  "H"),
        ("visite_satese",   "Visite Satèse",                       "H"),
    ]),
    ("bac", "Bac à graisse", [
        ("pomp_bac_graisse", "Pompage nettoyage bac à graisses", "U"),
        ("pomp_bac_mousse",  "Pompage nettoyage bac à mousse",   "U"),
        ("pomp_siphon",      "Pompage curage siphon",            "U"),
    ]),
